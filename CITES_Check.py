...
def get_CITES ():
	...
	if args.fu == True:
		path = call(['./Retrieve_CITES.py', '-c', args.c, '-f'], shell=True)
	else:
		path = call(['./Retrieve_CITES.py', '-c', args.c], shell=True)
...
def run_Blast ():
	...
	path = call(['./Blast_and_Compare.py', '-i', args.i, '-o', args.o, '-c', args.c,
			'-a', args.a, '-d', args.d, '-s', args.s, '-m', args.m,
			'-mi', args.mi, '-mc', args.mc, '-me', args.me, '-b', args.b], shell=True)

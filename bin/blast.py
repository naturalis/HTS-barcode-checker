...
fasta_handle = NCBIWWW.qblast("{algorit}".format(algorit = algorit), "{database}".format(database = database), fasta_handle, megablast = args.megablast, hitlist_size = size_hitlist, word_size = args.wordsize, gapcosts = "5 5", nucl_penalty = "-5" , nucl_reward = "4")  # define blast parameters for blast search
